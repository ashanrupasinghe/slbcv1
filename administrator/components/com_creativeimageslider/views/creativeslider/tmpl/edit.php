					...
					<div class="tab-pane active" id="details">
						<div class="control-group">
							...
							<div class="cis_controls">
									...
									$opts = array(0 => JText::_('COM_CREATIVEIMAGESLIDER_OPENEVENT_BUTTON'), 1 => JText::_('COM_CREATIVEIMAGESLIDER_OPENEVENT_OVERLAY'), 2 => JText::_('COM_CREATIVEIMAGESLIDER_OPENEVENT_LINK'), 3 => JText::_('COM_CREATIVEIMAGESLIDER_OPENEVENT_NONE'));
									$options = array();
							...
							<div class="cis_controls">
									...
									$opts = array(0 => JText::_('COM_CREATIVEIMAGESLIDER_SLIDE_UP'), 1 => JText::_('COM_CREATIVEIMAGESLIDER_KEEP_VISIBLE'), 2 => JText::_('COM_CREATIVEIMAGESLIDER_SPECIAL'));
									$options = array();
							...
							<div class="cis_control_label"><label id="" for="cis_move_step" class="hasTooltip required" title="<?php echo JText::_( 'COM_CREATIVEIMAGESLIDER_MOVESTEP_DESCRIPTION' );?>" ><?php echo JText::_( 'COM_CREATIVEIMAGESLIDER_MOVESTEP_LABEL' );?></label></div>
							<div class="cis_controls"><input type="text" name="move_step" id="cis_move_step" value="<?php echo $v = $this->item->id == 0 ? $slider_global_options['move_step'] : $this->item->move_step;?>" class="inputbox" size="40" required="" ></div>
